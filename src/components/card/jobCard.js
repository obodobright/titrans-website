  ...
  return (
    <section className="relative">
      <div className="min-h-[240px] rounded-[20px] w-full  relative ">
        <div className="min-h-[280px] transition-all translate-y-0 opacity-0 hover:opacity-100 hover:cursor-pointer p-4 flex items-start  flex-col justify-end  w-full rounded-[20px]   absolute top-0 z-10 bg-[#181818BF]   ">
